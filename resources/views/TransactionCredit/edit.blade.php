...
<div class="col-md-12">
    <div class="row justify-content-center">
        ...
        <div class="card">
                <div class="card-header">{{ __('Edit TransactionCredit') }}</div>
                <div class="card-body">
                    @if ($errors->any())
                        ...
                        @endif
                        <form method="POST" action="{{ route('TransactionCredit.update',$TransactionCredit->id) }}">
                        @csrf
                        @method("patch")
                        <div class="row">
                            @include('package._edit_form')
