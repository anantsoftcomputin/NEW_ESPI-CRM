...
{{-- <li class="menu active menu-single">
    <a href="{{ route('home') }}" data-active="false" class="menu-toggle">
        <div class="base-menu">
...
{{-- @can(["view-permission","create-permission"])
<li class="menu menu-single">
    <a href="{{ route('permissions.index') }}" data-active="false" class="menu-toggle">
        <div class="base-menu">
            <div class="base-icons">
...
@canany(['view-user','view-role','view-university','view-course','view-card'])
<li class="menu">
...
{{-- <li class="menu  menu-single">
    <a href="{{ route('/package') }}"  class="menu-toggle">
        <div class="base-menu">
            <div class="base-icons">
...
<li class="menu menu-single">
    <a href="{{ url('/admin/card') }}" data-active="false" class="menu-toggle">
        <div class="base-menu">
            <div class="base-icons">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-grid"><rect x="3" y="3" width="7" height="7"></rect><rect x="14" y="3" width="7" height="7"></rect><rect x="14" y="14" width="7" height="7"></rect><rect x="3" y="14" width="7" height="7"></rect></svg>
            </div>
...
@can(["view-application_status"])
<li class="menu menu-single">
    <a href="{{ url('/admin/package') }}" data-active="false" class="menu-toggle">
        <div class="base-menu">
            <div class="base-icons">
