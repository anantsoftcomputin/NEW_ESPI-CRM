            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav mr-auto">
                        @auth
                        <a class="navbar-brand" href="{{ route('Enquires.index') }}">
                            {{ __('enquire.top_menu') }}
                        </a>
                        <a class="navbar-brand" href="{{ route('Application.index') }}">
                            {{ __('application.top_menu') }}
                        </a>
                        <a class="navbar-brand" href="{{ route('University.index') }}">
                            {{ __('university.top_menu') }}
                        </a>
